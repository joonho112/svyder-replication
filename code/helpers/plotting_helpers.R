...
TIER_COLORS <- c(
  "I-a" = COL_FW,  # within-group fixed effects
  "I-b" = COL_FB,  # between-group fixed effects
  "II"  = COL_RE,  # random effects
  "III" = COL_RED  # excluded hyperparameters
)

TIER_LABELS <- c(
  "I-a" = "I-a: within-group fixed effects",
  "I-b" = "I-b: between-group fixed effects",
  "II"  = "II: random effects",
  "III" = "III: excluded hyperparameters"
)
